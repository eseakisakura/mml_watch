...
　Powershellで組むFM音源波形プログラムの、
　サンプルスクリプトです。


　濃色グラフは、Op.1(モジュレーション、変調波)
　薄色グラフは、Op.2(キャリア、搬送波)となっています。


　当スクリプトは、構造化エディタに対応しています。
